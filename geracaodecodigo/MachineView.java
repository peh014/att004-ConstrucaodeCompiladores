...
public class MachineView extends JFrame {
    ...
    private void initComponents() {
        ...
        jTextAreaProgram.setName("jTextAreaProgram");
        ...
        jScrollPaneStack.setName("jScrollPaneStack");

        jTextAreaStack.setColumns(20);
        jTextAreaStack.setRows(5);
        jTextAreaStack.setName("jTextAreaStack");
        ...
        jLabel2.setText("Memória de programa");
        ...
        jTextFieldInput.setName("jTextFieldInput");
        ...
        jTableMemory.setName("jTableMemory");
